...
public class MessageAdapter extends RecyclerView.Adapter {
    Context context;
    ArrayList<MessegeModel> messagesAdpterArrayList;
    int ITEM_SEND=1;
    int ITEM_RECEIVE=2;

    public MessageAdapter(Context context, ArrayList<MessegeModel> messagesAdpterArrayList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        MessegeModel message = messagesAdpterArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String msg = messagesAdpterArrayList.get(position).getMessage();
    ...
    public int getItemViewType(int position) {
        MessegeModel messages = messagesAdpterArrayList.get(position);
